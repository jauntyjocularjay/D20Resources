# Modern Advanced Classes

[Index](../../readme.md) > [Modern](./Modern.md) > [Modern Advanced Classes](../ModernAdvClasses.md)
...
It is typically of Tiny or Diminutive size, so that it can be easily held and manipulated in one hand, and its weight is negligible, so that it does not affect the Acolyte's carrying capacity.
...
Try Again?: You can try again, but doing so does not cancel the effects of a previous failure. If you lost a spell, the spell is lost.
...
| DC | Task |
| --- | --- |
| 15 + spell level | Identify a spell being cast. (You must see or hear the spell's verbal or somatic components.) You cannot try again. |
| 15 + spell level | When casting detect magical aura, determine the school of magic involved in the aura of a single item or creature you can see. (If the aura is not a spell effect, the DC is 15 + one-half caster level.) |
| 20 + spell level | Identify a spell that is already in place and in effect. (You must be able to see or detect the effects of the spell.) You cannot try again. |
| 20 + spell level | Identify materials created or shaped by magic, such as noting that an iron wall is the result of a wall of iron spell. You cannot try again. |
...
| 30 or higher | Understand a strange or unique magical effect. You cannot try again. |

[Return to Table of Contents](#table-of-contents)

### Divine Spells

The Acolyte's key characteristic is the ability to cast divine spells.
...
Range: The Acolyte turns the closest turnable creature first. She cannot turn creatures that are more than 60 feet away or that have total cover.

Turning Check: First, roll a turning check to determine how powerful a creature you can turn. This is a Charisma check (1d20 + Charisma modifier). The table below shows the Hit Dice of the most powerful creature you can affect, relative to your Acolyte level. With a given turning attempt, you cannot turn any creature whose Hit Dice exceeds the result of your turning check.
...
The Acolyte can command any number of creatures whose total Hit Dice do not exceed her Acolyte level. She may voluntarily relinquish command in order to establish command on different creatures.
...
At 7th level, the Acolyte gains the supernatural ability to affect magical beasts. This ability works just like turning undead, except the creature type is magical beast. Magical beasts, unlike undead creatures, cannot be destroyed or commanded. All other rules pertaining to turning apply. The number of times per day the Acolyte can make a turning attempt (3 + Cha modifier) does not increase.
...
Resist Fear: In response to a fear effect, you can make an Autohypnosis check on your next action even if you have been overcome by fear. A successful check grants you another saving throw with a +4 morale bonus to resist the fear effect.
...
Try Again?: For resist fear and memorize, you can make a check once per round. You cannot try again to tolerate poison. You cannot try again in the same round for willpower.

Special: You can take 10 on Autohypnosis checks, but you cannot take 20.
...
Try Again?: You can try again, but doing so does not cancel the effects of a previous failure. If you lost a power, the power is lost.
...
### Battle Mind Psionic Powers

The Battle Mind's main strength is her ability to manifest offensive psionic powers.

A psionic power is a one-time psionic effect. Psionic powers require power points to use. Unlike arcane spellcasters, Battle Minds do not have spellbooks and they do not prepare powers ahead of time. In addition, a Battle Mind can use psionics while wearing armor without risking the failure of the power.
...
The Battle Mind's selection of powers is extremely limited and tied to combat. At 1st level, a Battle Mind knows two 0-level powers of your choice. At each level, the Battle Mind discovers one or more previously latent powers, as indicated on the table above.
...
Starting at 2nd level, a Battle Mind can create tattoos on his body or someone else's that can be used to invoke psionic powers. A tattoo is a single-use item that duplicates the effect of a particular power. Imprinting a tattoo takes one day. The purchase DC for the raw materials to imprint a tattoo is 15 + the tattoo's power level + the tattoo's manifester level.
...
At 7th level or higher, a Field Medic can save a character reduced to -10 hit points or lower. If the Field Medic is able to administer aid within 3 rounds of the character's death, he or she can make a Treat Injury check. The DC for this check is 30, and the Field Medic cannot take 10 or take 20. If the check succeeds, the dead character can make a Fortitude save (DC 15) to stabilize and be restored to 0 hit points.

If the Field Medic fails the skill check or the patient fails the save, the dead character cannot be saved.

[Return to Table of Contents](#table-of-contents)

### Medical Miracle

At 10th level, a Field Medic can revive a character reduced to -10 hit points or lower. If the Field Medic is able to administer aid within 3 minutes of the character's death, he or she can make a Treat Injury check. The DC for this check is 40, and the Field Medic cannot take 10 or take 20. If the check succeeds, the dead character can make a Fortitude save (DC 20) to stabilize and be restored to 1d6 hit points.

If the Field Medic fails the skill check or the patient fails the Fortitude save, the dead character cannot be restored.

[Return to Table of Contents](#table-of-contents)

## Field Scientist

### Field Scientist Requirements
...
### Field Scientist Class Information
...
Electronic devices, special tools, weapons, mechanical devices, and more can be built with scientific improvisation. It takes a full-round action to make an object with scientific improvisation. The object, when put into use, lasts for a number of rounds equal to the Field Scientist's class level, or until the end of the current encounter, before it breaks down. It cannot be repaired.

[Return to Table of Contents](#table-of-contents)

### Field Scientist Bonus Feats
...
The Gunslinger adds +1 to all attack rolls made using the selected personal firearm.

[Return to Table of Contents](#table-of-contents)

### Gunslinger Bonus Feats
...
| --- | --- |
| 15 + spell level | Identify a spell being cast. (You must see or hear the spell's verbal or somatic components.) You cannot try again. |
| 15 + spell level | Learn a spell from a spellbook or scroll. You cannot try again for that spell until you gain at least 1 rank in Spellcraft. |
...
#### Mage Bonus Spells by Spell Level
...
A Mage can prepare a lower-level spell in place of a higher-level one if he desires.
...
Depending on what kind of creature the familiar is, the master gains a special benefit, as summarized in the table below.
...
Saving Throws: The familiar uses the Mage's base saving throw bonuses if they are better than the familiar's. The familiar uses its own ability modifiers to saves, and does not enjoy other bonuses that the Mage may have (such as from feats).
...
Empathic Link (Su): The Mage has an empathic link with the familiar out to a distance of up to 1 mile. The Mage cannot see through the familiar's eyes, but the two of them can communicate telepathically. Note that the relatively low Intelligence of a low-level Mage's familiar limits what it is able to communicate or understand, and even intelligent familiars see the world differently from humans.
...
At 4th level, a Mage can create tattoos on his body or someone else's. Tattoos function similarly to scrolls and are created in the same way (see the Scribe Scroll ability), except that the pertinent skill is Craft (visual arts).

[Return to Table of Contents](#table-of-contents)

### Spell Mastery

At 5th and 8th level, a Mage gains the spell mastery ability. Each time, the Mage chooses a number of spells that he already knows equal to his Intelligence modifier. From that point on, the Mage can prepare these spells without referring to a spellbook. The Mage is so intimately familiar with these spells that he does not need a spellbook to prepare them anymore.
...
### Martial Artist Class Information
...
A successful Will save does not restore previous attitude shifts, but it does render the target immune for 24 hours to further attempts by the Negotiator to sow distrust.

The Negotiator cannot use this talent on his or her allies.
...
This skill use does not allow you to use the class feature of another class. It just lets you activate items as if you had the class feature.
...
Emulate Ability Score: To cast a spell from a scroll, you need a high ability score in the appropriate ability (Intelligence for arcane spells, Wisdom for divine spells). Your effective ability score (appropriate to the class you are emulating when you try to cast a spell from a scroll) equals your check result minus 15. If you already have a high enough score in the ability, you do not need to make this check.
...
In addition, casting a spell from a scroll requires a minimum score of 10 + the spell's level in the appropriate ability. If you do not have a sufficiently high score, you must emulate the ability score with a separate check (see above).
...
Try Again?: Yes, but if you ever roll a natural 1 while attempting to activate an item and you fail the check, then you cannot try to activate that item again for 24 hours.

Special: You cannot take 10 or take 20 with this skill. Magic is too unpredictable to make the use of this skill reliable.

[Return to Table of Contents](#table-of-contents)

### Occultist Spell Resistance
...
### Occultist Arcane Research (Scrolls)
...
At 4th level, an Occultist gains a denizen of Shadow as a contact. The Shadow creature can have HD equal to one-half the Occultist's class level or less. This Shadow creature may or may not be overtly hostile toward humans, but it tolerates the Occultist. The Shadow creature will provide information or other minor assistance as though its attitude toward the Occultist were friendly. It might still omit important details, depending on its relationship with the Occultist.

The Shadow creature does not accompany the Occultist on adventures, and it may not always be available when the Occultist wants it. In most cases, the Shadow contact can be called upon once per week, and the creature requires some form of compensation for each favor. Compensation can be a favor in return or something appropriate to the creature in question.
...
### Occultist Arcane Research (Items)
...
At 10th level, an Occultist comes into her full power. By spending 1 action point and an attack action, the Occultist can utter a word of power that forces a denizen of Shadow to return to the Shadow dimension. The Shadow creature gets a Will save (DC 10 + Occultist's level + Occultist's Charisma modifier), adding a bonus equal to its HD to the save. If the save succeeds, the Shadow creature does not disappear but is instead stunned for 1d4+1 rounds.
...
When a Personality buys a ticket to a show or for transportation, he or she can make a Diplomacy check to get that ticket upgraded. DCs are given above.
...
At 5th level, a Personality develops such a force of personal magnetism that he or she can convince a single target to regard him or her as a trusted friend. (If the target is currently being threatened or attacked by the Personality or his or her allies, this ability will not work.)
...
This ability does not enable the Personality to control the target, but the target perceives the Personality's words and actions in the most favorable way. The Personality can try to give the target orders, but he or she must win an opposed Charisma check to convince the target to perform any actions the target would not normally undertake. The target never obeys suicidal or obviously harmful orders, and any act by the Personality or his or her allies that threatens the target breaks the mood and clears the target's head. Otherwise, a target remains won over for 1 minute per Personality level.
...
The amount of information gleaned by this uncanny awareness depends on how long the Slayer focuses attention.

1. 1st Round: Presence or absence of Shadow creatures.
2. 2nd Round: Number of Shadow auras (creatures or objects of Shadow) in the area and the power of the strongest Shadow aura present. If the power of the strongest Shadow aura is overwhelming, and has a rating of at least twice the Shadow Slayer's character level, the Slayer is stunned for 1 round and the use of this ability ends. While stunned, the Slayer cannot act, loses any Dexterity bonus to Defense, and attackers gain a +2 bonus on attacks made against him.
3. 3rd Round: The power of each Shadow aura in the area becomes clear. If an aura is outside the Slayer's line of sight, then he discerns its direction but not its exact location.
...
At 2nd level, a Shadow Slayer gains damage reduction against the natural weapons of the denizens of Shadow (claws, bite, and so on). Shadow immunity does not reduce the damage dealt by firearms, melee weapons, or hazardous effects. The damage reduction is equal to one-half of the Slayer's level in this advanced class, rounded down.

[Return to Table of Contents](#table-of-contents)

### Shadow Slayer Bonus Feats
...
At 5th and 7th level, a Shadow Slayer selects a type of Shadow creature as a favored enemy. Due to extensive study of these foes and training in the proper techniques for combating them, the Shadow Slayer gains a +1 bonus on Bluff, Listen, Search, Sense Motive, and Spot checks when using these skills against creatures of this type. He also gets a +1 bonus on weapon damage rolls against creatures of this type.

At each level after 5th, the Shadow Slayer may add +1 to the value of the bonus against each favored enemy type.
...
Starting at 8th level, a Shadow Slayer gains fast healing. Every round, the Shadow Slayer recovers a number of hit points equal to one-half his level in this advanced class. So, as an 8th-level Shadow Slayer, he recovers 4 hit points every round.
...
At 10th level, a Shadow Slayer comes into full power. By spending 1 action point and using an attack action, the Shadow Slayer can utter a word of power that can devastate creatures of Shadow. The word of slaying affects any denizens of Shadow within 15 feet of the Slayer. The ill effects depend on the Hit Dice of the creatures, as shown above.

A dazed creature cannot act for 1d4 rounds. A stunned creature is stunned for 2d4 rounds. A paralyzed creature cannot move or act for 1d10 minutes. A killed creature dies (if it is living) or is destroyed (if it is a construct or an undead).
...
As a full-round action, the Soldier provides tactical aid to all allies (including himself) within sight and voice range of his position. This use of tactical aid requires an action point.
...
By spending 1 action point and making either a Craft (electronic) or Craft (mechanical) check (whichever is appropriate for the machine in question), the Techie can temporarily improve a machine's performance at the risk of causing the machine to need repairs later. The DC for the Craft check depends on the type of improvement being made, as shown below.

The Techie performs the extreme modifications in 1 hour. The Techie cannot take 10 or take 20 on this check. If the check succeeds, the effect of the improvement lasts for a number of minutes equal to the Techie's class level, beginning when the object is first put into use. The Techie selects the single improvement to make prior to making the check. After the duration of the effect ends, the machine reverts to its previous state and a repair chance percentile roll is made. The result of this roll indicates whether the machine requires repairs before it can be used again.
...
The Techie must have at least 1 rank in the skill to be programmed into the robot. The Techie can only control one robot at a time, and only one of the Techie's robots can be active at any time.

Follow these steps to build a robot.

1. Wealth Check: The purchase DC for the components needed to construct a robot is based on the robot's size.
...
2. Construct Frame: The robot's body determines its size, shape, locomotion, and hit points. The DC of the Craft (mechanical) check is set by the robot's size and modified by the form of locomotion selected.
...
| Component Category | Option | DC Modifier |
| --- | --- | --- |
| Frame Shape and Locomotion (select one) | Bipedal | +4 |
| Frame Shape and Locomotion (select one) | Quadruped | +3 |
| Frame Shape and Locomotion (select one) | Treads | +2 |
| Frame Shape and Locomotion (select one) | Wheels | +1 |
| External Components (select one or more) | Manipulators | +3 |
| External Components (select one or more) | Audio/visual sensor | +2 |
| Remote Range (select one) | Remote control link, 100 feet | +1 |
| Remote Range (select one) | Remote control link, 200 feet | +3 |
| Remote Range (select one) | Remote control link, 300 feet | +5 |

Manipulators are necessary for a robot built to use any skill except Listen or Spot.

Select a frame size and form, add manipulators and sensors as necessary, and choose a type of remote control link. Add all modifiers to determine the check's DC. Make the Craft (mechanical) check to construct the robot's frame.
...
3. Construct the Electronics: The next step is to build the internal electronics for the robot and install them in the frame. The DC is based on the size of the robot and modified by the number of components that need to be wired together.

For a Diminutive robot, the DC is 20. For a Tiny robot, the DC is 15. Add +1 to the DC for each external component and +2 for the remote link. Make the Craft (electronic) check.

It takes a Techie 12 hours to wire a Diminutive robot or 6 hours to wire a Tiny robot.

4. Program the Robot: The Techie programs the robot as the final step. Decide how many ranks of the appropriate skill to program into the robot, up to the number of ranks the Techie has in the skill. A Techie's robot can contain programming for only one skill. Make the Computer Use check to program the robot.
...
At 5th level, the Techie becomes adept at creating mastercraft objects. He or she applies the mastercraft ability to one of his or her Craft skills (electronic or mechanical). From this point on, he or she can build mastercraft objects using that skill.
...
In addition to the Wealth check, the Techie must also pay a cost in experience points equal to 25 x Techie level x the bonus provided by the mastercraft feature. The XP must be paid before making the Craft check. If the expenditure of these XP would drop the Techie below the minimum needed for the current level, then the XP cannot be paid and the Techie cannot use the mastercraft ability until enough additional XP are gained.
...
At 8th level, the Techie can add the mastercraft ability to another Craft skill, or improve ability in the skill selected at 5th level so that mastercraft objects provide a +2 bonus.

At 10th level, the Techie adds another +1 bonus to the mastercraft ability. If the Techie focuses on one Craft skill, mastercraft objects now provide a +3 bonus. If the Techie already has the ability for both Craft skills, choose which one improves to a +2 bonus.

The Craft DC for a mastercraft object is the same as for a normal object of the same type, with the following modification: for a +1 object, add +3 to the Craft DC; for a +2 object, add +5 to the Craft DC; and for a +3 object, add +10 to the Craft DC.
...
Resist Fear: In response to a fear effect, you can make an Autohypnosis check on your next action even if you've been overcome by fear. A successful check grants another saving throw with a +4 morale bonus to resist the fear effect.

Memorize: You can attempt to memorize a long string of numbers, a long passage of verse, or other particularly difficult piece of information. Each successful check allows you to memorize up to 250 words or the equivalent of what could be comfortably contained on an 8 1/2-by-11-inch sheet of paper. You always retain this information; however, you can only recall it with a successful Autohypnosis check.

Tolerate Poison: In response to being poisoned, you can make an Autohypnosis check on your next action. A successful check grants a +4 morale bonus on your saving throw to resist the poison's secondary damage.
...
| DC | Task |
| --- | --- |
| 15 + power level | Identify a psionic power as it manifests. (You must sense the power's display or see some visible effect to identify a power.) You cannot try again. |
| 20 + power level | Identify a power that's already in place and in effect. (You must be able to see or detect the effects of the power.) You cannot try again. |
| 20 + power level | Identify materials created or shaped by psionics. You cannot try again. |
| 30 or higher | Understand a strange or unique psionic effect. You cannot try again. |
...
### Telepath Psionic Powers

The Telepath's main strength is the ability to manifest psionic powers.
...
A psionic power is a one-time psionic effect. Psionic powers require power points to use. Unlike arcane spellcasters, Telepaths do not have spellbooks and do not prepare powers ahead of time. In addition, a Telepath can use psionics while wearing armor without risking failure of the power.
...
The Telepath's selection of powers is extremely limited, although he enjoys ultimate flexibility. At 1st level, a Telepath knows three 0-level powers of your choice and one 1st-level power. At each level, the Telepath discovers one or more previously latent powers, as indicated on the table above.
...
A Telepath can manifest a certain number of powers per day based on available power points. (0-level powers have a special cost.) He pays the power point cost of a power to manifest it, with no preparation necessary. The base number of power points available per day is shown on the table above. This number is improved by bonus points determined by the Telepath's Charisma score, as shown on the bonus power points table.
